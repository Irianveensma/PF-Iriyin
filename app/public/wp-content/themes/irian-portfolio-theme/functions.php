...
function irian_enqueue_assets() {
	wp_enqueue_style( 'irian-style', get_stylesheet_uri(), array(), '0.30.0' );
	wp_enqueue_style( 'irian-panels', get_template_directory_uri() . '/assets/panels.css', array(), '0.30.0' );
	wp_enqueue_style( 'irian-site', get_template_directory_uri() . '/assets/site.css', array( 'irian-panels' ), '0.30.0' );
	wp_enqueue_style(
		'irian-fonts',
	...
	wp_enqueue_script( 'irian-site', get_template_directory_uri() . '/assets/site.js', array(), '0.30.0', true );
